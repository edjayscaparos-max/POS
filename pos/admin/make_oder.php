              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="order_code" readonly id="order_code" value="<?php echo $alpha; ?>-<?php echo $beta; ?>" class="form-control" value="">
                  </div>
                </div>
                <hr>
                <?php
                ...
                ?>
                  <div class="form-row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" name="prod_qty" class="form-control" value="" required="">
                    </div>
                  </div>
                <?php } ?>
                <br>
